    ...
    return (
        <div className="relative w-full">
            <textarea
                ...
                border border-main-dark/[0.5] border-t-transparent bg-transparent px-3 py-2.5 font-sans text-sm font-normal 
                text-main-dark outline outline-0 transition-all placeholder-shown:border placeholder-shown:border-main-dark/[0.5] 
                placeholder-shown:border-t-main-dark/[0.5] focus:border-2 focus:border-main-dark focus:border-t-transparent 
            ...
            <label className="before:content[' '] after:content[' '] pointer-events-none absolute left-0 -top-1.5 
                ...
                text-main-dark transition-all before:pointer-events-none before:mt-[6.5px] before:mr-1 
                before:box-border before:block before:h-1.5 before:w-2.5 before:rounded-tl-md before:border-t before:border-l 
                before:border-main-dark/[0.5] before:transition-all after:pointer-events-none after:mt-[6.5px] after:ml-1 
                after:box-border after:block after:h-1.5 after:w-2.5 after:flex-grow after:rounded-tr-md after:border-t after:border-r 
                after:border-main-dark/[0.5] after:transition-all peer-placeholder-shown:text-sm peer-placeholder-shown:leading-[3.75] 
                peer-placeholder-shown:text-main-dark/[0.5] peer-placeholder-shown:before:border-transparent 
