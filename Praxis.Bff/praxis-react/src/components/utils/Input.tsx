        ...
        <div className="relative h-10 w-full">
            ...
            className={`px-3 py-2.5
                    ...
                    disabled:border-0 disabled:bg-blue-gray-50` + (missingRequired? 
                        "border-main-error-light    focus:border-main-error-dark placeholder-shown:border-main-error-light    placeholder-shown:border-t-main-error-light" 
                      : "border-main-highlight-dark focus:border-main-dark       placeholder-shown:border-main-highlight-dark placeholder-shown:border-t-main-highlight-dark")}
            ...
            <label className={`before:content[' '] after:content[' '] pointer-events-none 
                        ...
                        peer-disabled:peer-placeholder-shown:text-blue-gray-500` + (missingRequired? 
                          ...
                          : "text-main-highlight-dark before:border-main-highlight-dark after:border-main-highlight-dark peer-placeholder-shown:text-main-highlight-dark peer-focus:text-main-dark       peer-focus:before:border-main-dark         peer-focus:after:border-main-dark")}>
            {props.label}
            </label>
        </div>);
}
